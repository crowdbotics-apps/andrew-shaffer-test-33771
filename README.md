...
## Project Structure
    ...
    ├── andrew_shaffer_test_33771  # Django project configurations
...
1. Clone this repo and `cd andrew_shaffer_test_33771`
...
2. Clone this repo and `cd andrew_shaffer_test_33771`
